...
- [x] **Add an introduction to help new users** - A new user has lots of things, especially little unknowns, that a intro page on first start could help with. Also could add a help button to bring it back up.
- [x] **After the intro it should also off them the setup wizard** - right now you have to know to go find the wizard, a new user should be asked if they want to use it.

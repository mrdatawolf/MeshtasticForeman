...
Implemented and committed (873de79, 2026-08-24). Board entry was stale
("Not started") relative to git history; corrected 2026-08-25.

### Changes made

- Added a quarterly review cadence to `docs/DEVELOPMENT.md`: run
  `pnpm outdated`, and check Node/pnpm support status against the pinned
  `engines`/`packageManager` fields.
- Documentation only, no code change.

### Validation performed

Documentation only; no automated validation applicable.
